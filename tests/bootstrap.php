 ...
 */
function _tests_load_edd_prod_support() {
	define( 'EDD_PROD_SUPPORT_DIRECTORY_PATH', trailingslashit( dirname( dirname( __FILE__ ) ) ) );
	require EDD_PROD_SUPPORT_DIRECTORY_PATH . 'edd-product-support.php';
}
tests_add_filter( 'muplugins_loaded', '_tests_load_edd_prod_support' );
